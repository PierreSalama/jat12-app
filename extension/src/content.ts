...
import type { Cmd, CmdResult, TypedEnvelope } from '@jat12/shared/protocol';
import { PROTOCOL_VERSION } from '@jat12/shared/constants';
...
const port = chrome.runtime.connect({ name: 'jat12.page' });
