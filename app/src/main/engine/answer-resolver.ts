...
import type { SnapNode } from '@jat12/shared/protocol';
import type { AdapterDoc, PageDef, FieldRule } from '@jat12/shared/adapter-schema';
import { normQuestion } from '@jat12/shared/norm';
