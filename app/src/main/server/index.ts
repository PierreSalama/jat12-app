// The local server: Hono REST + (later) the /drive WebSocket. Loopback-only on 127.0.0.1:7845.
...
// Every other route will require the X-JAT12-Token pairing header; that middleware arrives with
...
import { PORTS, PROTOCOL_VERSION, IDENTITY } from '@jat12/shared';
