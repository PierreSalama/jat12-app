// `npm run dev` — build once, then launch Electron with the dev identity (port 7846, userData
// jat12-app-dev). NOTE the native-ABI dance: vitest runs better-sqlite3 under NODE's ABI, Electron
