...
import { PageSnapshot, Cmd, CmdResult, ExtEvent, Envelope } from '@jat12/shared/protocol';
import { AdapterDoc, parseAdapter, Signal, Oracle } from '@jat12/shared/adapter-schema';
