...
// and copies manifest.json + popup assets beside the bundle. @jat12/shared is TS source, so it's
...
const common = {
  ...
  target: ['chrome116'],
  logLevel: 'info',
  // @jat12/shared (incl. its zod dep) is bundled in — the extension ships zero runtime deps.
  external: [],
};
